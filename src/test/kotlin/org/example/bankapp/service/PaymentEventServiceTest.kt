...
import org.example.bankapp.service.payment.PaymentEventIdService
import org.junit.platform.commons.logging.LoggerFactory
import org.springframework.beans.factory.annotation.Autowired
import org.springframework.boot.test.context.SpringBootTest

@SpringBootTest(classes = [PaymentEventIdService::class])
    ...
    init {
        Given("memberId 가 주어지면") {
            ...
            When("결제 이벤트 아이디가 생성될 때") {
                val paymentEventId = paymentEventIdService.createPaymentEventId(memberId)
