...
- [1장. 오브젝트와 의존 관계](#1장-오브젝트와-의존-관계)
  - [1. 제어의 역전(IoC)](#1-제어의-역전ioc)
    - [1.1 오브젝트 팩토리](#11-오브젝트-팩토리)
      - [1.1.1 팩토리 사용의 이점](#111-팩토리-사용의-이점)
      - [1.1.2 오브젝트 팩토리 활용](#112-오브젝트-팩토리-활용)
      - [1.1.3 제어권의 이전을 통한 제어관계 역전](#113-제어권의-이전을-통한-제어관계-역전)
      - [1.1.4 오브젝트 팩토리를 이용한 스프링 IoC](#114-오브젝트-팩토리를-이용한-스프링-ioc)
    - [1.2 애플리케이션 컨텍스트(Application Context)](#12-애플리케이션-컨텍스트application-context)
      - [1.2.1 스프링 IoC의 용어 정리](#121-스프링-ioc의-용어-정리)
    - [2. 출처](#2-출처)
