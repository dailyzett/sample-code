...
<body>
	...
	<div class="div1">
		...
		<fmt:formatDate var="resultRegDt" value="${qdto.qb_date}" pattern="yyyy-MM-dd"/>
			...
			<c:if test="${sessionScope.sessionId eq qdto.writer_id && sessionScope.sessionId ne 'itcen1234'}">
				<button type="button" onclick="location.href='modifyQuestion?qb_id=${qdto.qb_id}'">수정</button>
