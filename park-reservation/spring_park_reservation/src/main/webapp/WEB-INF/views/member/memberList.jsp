...
<div class="center">
	...
	<table class="memberlist">
		...
		<fmt:formatDate var="resultRegDt" value="${member.regit_date}" pattern="yyyy-MM-dd hh:mm"/>
		<tr>
			<td style="width:8%;">${member.m_id }</td>
			<td><a href="adminMemberModify?username=${member.username }">${member.username }</a></td>
			<td style="width:7%;">${member.name }</td>
			...
			<c:if test="${member.member_role eq 'normal'}">
				<c:set var="membership" value="일반"/>
			</c:if>
