...
<c:if test="${sessionScope.sessionId eq requestScope.writerId }">
...
<c:if test="${sessionScope.sessionId ne requestScope.writerId }">
	<script>
...
<body>
	...
	<form action="modifyBoardProcess.do" method="post" name="qboardName">
		...
		<table class="writeform">
			...
			<tr>
				...
				<td><textarea name="content" rows="30" cols="100"
						placeholder="내용 입력.."><c:out value="${content }" /></textarea></td>
