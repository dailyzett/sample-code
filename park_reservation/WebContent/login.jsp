...
<div id = "login" class="tabcontent">
	<div class="loginform">
		<form action="login.do" style="border:1px solid #ccc" method="post">
			<div class="container">
				<h1>로그인</h1>
	
    			<label for="loginId"><b>아이디</b></label><br/>
    			...
    			<c:if test="${requestScope.loginStatus eq 'idfail' }">
    				<font color="red">아이디를 찾을 수 없습니다. <br/><br/></font>
    			</c:if>
		
    			<label for="loginPw"><b>패스워드</b></label><br/>
...
<div class="joinform">
  <form action="joinSuccess.do" style="border:1px solid #ccc" method="post" name="userInfo" onsubmit="return checkValue()">
  <div class="container">
    <h1>회원 가입</h1>
    <p>국립 공원 예약 홈페이지에 온 것을 환영합니다</p>
    <hr>
    
    <label for="username"><b>아이디</b></label><br/>
    ...
    <label for="pw"><b>패스워드</b></label><br/>
    <input type="password" placeholder="패스워드를 입력하세요" name="pw" required><br/>

    <label for="pw-repeat"><b>패스워드 확인</b></label><br/>
    <input type="password" placeholder="패스워드 확인을 입력하세요" name="pwr" required><br/>
    
    <label for="email"><b>이메일</b></label><br/>
    <input type="text" placeholder="이메일을 입력하세요" name="email" required><br/>
    
	<label for="phone1"><b>전화번호</b></label>
	<br/>
    <input type="text" value="010" name="phone1" style="width:10%"required>
    
    -
    
    <input type="text" name="phone2" style="width:10%"required>
	-
    <input type="text" name="phone3" style="width:10%"required>
