...
<body>
	...
	<div class="div1">
		...
		<table class="writeform">
			...
			<tr>	
				<th>제목</th>
				<td style="font-weight:bold"><c:out value="${vo.title }"/></td>
			</tr>
		...
		<button type="button" onclick="location.href='notice'" style="margin-left: 20px;">목록보기</button>
		<c:if test="${sessionId eq 'itcen1234' }">
			<button type="button" onclick="location.href='modifyNotice?id=${vo.id}'">수정</button>
